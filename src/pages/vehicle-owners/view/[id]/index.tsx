...
import { getVehicleOwnerById } from 'apiSdk/vehicle-owners';
import { VehicleOwnerInterface } from 'interfaces/vehicle-owner';
import { VehicleListPage } from 'pages/vehicles';

function VehicleOwnerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('vehicle_owner', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/vehicle-owners/edit/${id}`} passHref legacyBehavior>
                    <Button
