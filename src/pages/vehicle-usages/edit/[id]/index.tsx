        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              ...
              isInvalid: !!formik.errors?.distance_travelled,
            }}
            name="distance_travelled"
            error={formik.errors?.distance_travelled}
            value={formik.values?.distance_travelled}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('distance_travelled', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'fuel_consumed',
              isInvalid: !!formik.errors?.fuel_consumed,
            }}
            name="fuel_consumed"
            error={formik.errors?.fuel_consumed}
            value={formik.values?.fuel_consumed}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('fuel_consumed', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
