...
import { getVehicleUsageById } from 'apiSdk/vehicle-usages';
import { VehicleUsageInterface } from 'interfaces/vehicle-usage';

function VehicleUsageViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('vehicle_usage', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/vehicle-usages/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Distance Travelled" text={data?.distance_travelled} />

                <FormListItem label="Fuel Consumed" text={data?.fuel_consumed} />
